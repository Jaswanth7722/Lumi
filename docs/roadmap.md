...
## Version 1.2 — Custom Character Skins
- SDK support for custom character `.glb` replacements
- Skin validation and sandbox for third-party assets
- Official skin marketplace

## Version 1.5 — Advanced Memory
- Memory graph visualization for users
- Memory-driven proactive suggestions
- Shared memory across multiple devices (opt-in, E2E encrypted)
