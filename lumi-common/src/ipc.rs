...
//!
//! Defines the typed message bus infrastructure for the Lumi platform.
...
/// Unique process identifier within the Lumi platform.
...
/// A fully-typed IPC message on the Lumi platform bus.
...
/// Core IPC channels on the Lumi message bus.
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize)]
pub enum Channel {
    // -- AI Core Channels --
