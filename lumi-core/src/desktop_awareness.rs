...
use lumi_common::desktop::{
    DesktopEvent, DesktopSnapshot, FocusDetectorConfig, FocusSignal, InputType, NotificationInfo,
    SystemInfo, UserActivity, WindowEntry, WindowInfo,
};
