...
use lumas_common::memory::{
    MemoryCandidate, MemoryEntry, MemoryQuery, MemoryQueryResult, MemoryType,
    RetentionConfig, RetrieverConfig, ScoredMemory, WriteMemoryRequest,
    WriteMemoryResult, composite_score,
};
...
mod tests {
    ...
    fn test_write_and_query_memories() {
        ...
        system.write_memory(WriteMemoryRequest {
            entry: create_test_memory("Working on Lumas project", MemoryType::Project, 0.7),
            generate_embedding: false,
        });
