...
use lumas_common::ai::{
    ...
    InferenceResponse, LatencyProfile, ProviderCapabilities,
};
...
impl AICore {
    ...
    pub fn build_request(
        ...
        InferenceRequest {
            ...
            messages: messages
                .iter()
                .map(|m| lumas_common::ai::Message {
                    role: lumas_common::ai::MessageRole::User,
                    content: m.clone(),
                })
                .collect(),
            tools: tools.to_vec(),
...
use lumas_common::tool::ToolDefinition;
