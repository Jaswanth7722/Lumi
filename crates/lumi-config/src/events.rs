...
//! These do not depend on lumi-runtime's Event trait to avoid circular dependencies.
//! The lumi-runtime crate bridges these to its event bus via adapter types.
...
/// Implemented by lumi-runtime to bridge to its typed event bus.
