...
//!
//! Defines error event types emitted to the Lumas event bus.
...
pub trait ErrorEventBus: Send + Sync + std::fmt::Debug {
...
// Implement Event trait from lumas-runtime if available
// This is a compile-time bridge that doesn't require lumas-runtime to be present
