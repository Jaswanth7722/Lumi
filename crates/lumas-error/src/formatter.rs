...
impl ErrorFormatter {
    ...
    /// Format a LumasError into a string.
    ///
    /// # Arguments
    ...
    /// # Returns
    /// A formatted string.
    pub fn format(&self, error: &LumasError) -> String {
        match self.kind {
    ...
    fn format_compact(&self, error: &LumasError) -> String {
    ...
    fn format_detailed(&self, error: &LumasError) -> String {
        let code = error.code().format(error.category());
    ...
    fn format_json(&self, error: &LumasError) -> String {
