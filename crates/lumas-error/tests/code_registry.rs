...
use lumas_error::error_code::{ERROR_CODE_REGISTRY, ErrorCode, lookup_error_code};
...
async fn test_error_code_format() {
    ...
    let formatted = code.format(&lumas_error::ErrorCategory::AiCore { provider: None });
