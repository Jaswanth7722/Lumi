...
//!
//! Compile-time registry mapping LUMAS_* env var names to config field paths and types.
...
#[derive(Debug, Clone)]
pub struct EnvEntry {
    /// The full environment variable name (e.g., "LUMAS_AI_TEMPERATURE").
...
/// Registry mapping LUMAS_* env var names to config field paths.
...
impl EnvRegistry {
    /// Load all LUMAS_* environment variables and return key-value pairs
...
pub static ENV_REGISTRY: EnvRegistry = EnvRegistry {
    entries: &[
        ...
        EnvEntry {
            env_var: "LUMAS_AI_INFERENCE_MODE",
        ...
        EnvEntry {
            env_var: "LUMAS_AI_CLOUD_PROVIDER",
