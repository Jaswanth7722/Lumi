//! # lumas-performance — Centralized Performance Observability for Lumi
//!
...
pub mod prelude {
    ...
    pub use crate::manager::{PerformanceManager, PerformanceSnapshot};
    pub use crate::collector::SubsystemId;
