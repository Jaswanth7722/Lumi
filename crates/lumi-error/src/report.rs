//! # Error Report
//!
//! Provides the serializable, exportable representation of a `LumiError`.
...
impl ErrorReport {
    /// Create a new error report from a LumiError.
    pub fn from_error(error: &LumiError, format: ReportFormat) -> Self {
