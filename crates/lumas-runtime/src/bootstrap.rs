...
impl Bootstrap {
    ...
    pub async fn bootstrap(&mut self) -> Result<RuntimeHandle, BootstrapError> {
        ...
        info!("=== Lumas Runtime Bootstrap Starting ===");
        ...
        let log_filter = std::env::var("LUMAS_LOG")
            .unwrap_or_else(|_| "lumas_runtime=info,lumas_config=info".into());
        ...
        info!("=== Lumas Runtime Bootstrap Complete ({uptime_ms}ms) ===");
