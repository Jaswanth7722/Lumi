...
/// Manages the graceful shutdown sequence for the Lumi runtime.
...
impl ShutdownManager {
    ...
    pub async fn shutdown(&mut self, handle: &RuntimeHandle) {
        ...
        info!("=== Lumi Runtime Shutdown Starting ===");
        ...
        info!("=== Lumi Runtime Shutdown Complete (uptime: {uptime_secs}s) ===");
    }
    ...
    pub async fn force_shutdown(&mut self, handle: &RuntimeHandle) {
        ...
        warn!("=== Lumi Runtime Forced Shutdown ===");
        ...
        info!("=== Lumi Runtime Forced Shutdown Complete ===");
    }
