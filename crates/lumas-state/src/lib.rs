//! # Lumas Hierarchical State Machine Framework
//!
//! The single authority on what Lumas is currently doing, what it is allowed to do next,
...
//! | lumas-runtime | src/lifecycle.rs | `LifecycleState` | 6 variants | **Adopt**: RuntimeMachine states |
