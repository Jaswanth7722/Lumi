//! # Lumi Wire Protocol — Binary Framing, Serialization, Security
//!
...
//! 3. **Indefinite backward compatibility** — a Lumi process compiled today must
//!    decode packets produced by a Lumi process compiled years from now, provided
