...
/// Used during migration from `lumi_common::ipc::LumiMessage`.
pub fn to_legacy(msg: &LumiMessage) -> lumi_common::ipc::LumiMessage {
    use lumi_common::ipc::{Channel, MessageType};
...
pub fn from_legacy(msg: &lumi_common::ipc::LumiMessage) -> Result<LumiMessage, CodecError> {
