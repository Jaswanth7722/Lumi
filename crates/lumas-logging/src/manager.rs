...
impl LogManager {
    ...
    pub async fn install(
        ...
        let mut sinks = DashMap::<String, SinkHandle>::new();

        // Console sink
        let console_sink = crate::sink::console::ConsoleSink::new(
    ...
    pub async fn add_sink(&self, sink: Box<dyn crate::sink::Sink>) -> Result<(), LogError> {
        ...
        self.inner.sinks.insert(name, SinkHandle::from_arc(Arc::from(sink)));
        Ok(())
    }
